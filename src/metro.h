...
int set_meter(metro_t* metro, const char* option_name, const char* meter);
const char* get_meter(metro_t* metro, int n, char** option_name);
int set_speed(metro_t* metro, const char* option_name, const char* speed);
const char* get_speed(metro_t* metro, int n, char** option_name);
int set_accents(metro_t* metro, const char* option_name, const char* accents);
const char* get_accents(metro_t* metro, int n, char** option_name);
