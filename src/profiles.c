 ...
 */
void toggle_profiles_cb(GtkToggleAction *action [[gnu::unused]], metro_t *metro) {
...
static void delete_show_profiles(metro_t* metro [[gnu::unused]]) {
}
...
static void delete_profile_selected(metro_t* metro [[gnu::unused]]) {
}
...
static int new_profile(metro_t* metro [[gnu::unused]]) {
  return 0;
}

/* option system callback for destroying profile option */
static void delete_profile(metro_t* metro [[gnu::unused]]) {
}
