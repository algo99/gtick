 ...
 */
static void response_cb(GtkDialog *dialog, gint response, options_t* options [[gnu::unused]]) {
  switch (response) {
...
void about_box(GtkAction *action [[gnu::unused]], metro_t* metro)
{
  GtkWidget* window;
  GtkWidget* vbox;
  GtkWidget* label;
...
void help_shortcuts(GtkAction *action [[gnu::unused]], metro_t *metro [[gnu::unused]]) {
