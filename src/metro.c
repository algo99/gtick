 ...
 */
static void toggle_visualtick_cb(GtkToggleAction *action [[gnu::unused]], metro_t *metro) {
 ...
 */
static void toggle_accenttable_cb(GtkToggleAction *action [[gnu::unused]], metro_t *metro) {
 ...
 */
static void metro_toggle_cb(GtkToggleAction *action [[gnu::unused]], metro_t *metro) {
  int new_state;
 ...
 */
static void quit_cb(GtkAction *action [[gnu::unused]], metro_t *metro)
{
  set_state(metro, STATE_IDLE);
 ...
 */
static void preferences_cb(GtkAction *action [[gnu::unused]], metro_t *metro)
{
...
static int set_sample(metro_t* metro,
                      const char* option_name [[gnu::unused]], const char* sample_name)
{
  if (metro->options->sample_name)
    free(metro->options->sample_name);
  else
...
static const char* get_sample(metro_t* metro,
                              int n [[gnu::unused]], char** option_name [[gnu::unused]])
{
...
static int set_sound_device_name(metro_t* metro,
                                 const char* option_name [[gnu::unused]],
 ...
 */
static void delete_min_bpm(metro_t* metro [[gnu::unused]]) {
}
 ...
 */
static void delete_max_bpm(metro_t* metro [[gnu::unused]]) {
}
 ...
 * returns 0 on success, -1 otherwise
 */
int set_speed(metro_t* metro, const char* option_name [[gnu::unused]], const char* speed)
{
 ...
 * if called with metro == NULL, returns NULL
 */
const char* get_speed(metro_t* metro, int n [[gnu::unused]], char** option_name [[gnu::unused]])
{
  if (metro == NULL) {
    return NULL;
  } else {
 ...
 */
static void delete_speed(metro_t* metro [[gnu::unused]]) {
}
...
int set_volume(metro_t* metro,
                      const char* option_name [[gnu::unused]], const char* volume)
{
 ...
 */
static void delete_volume(metro_t* metro [[gnu::unused]]) {
}
 ...
 * returns 0 on success, -1 otherwise
 */
int set_meter(metro_t* metro, const char* option_name [[gnu::unused]], const char* meter)
{
  int n;
 ...
 */
const char* get_meter(metro_t* metro, int n [[gnu::unused]], char** option_name [[gnu::unused]])
{
 ...
 */
static void delete_meter(metro_t* metro [[gnu::unused]]) {
...
static void delete_visualtick(metro_t* metro [[gnu::unused]]) {
}
...
static void delete_show_accenttable(metro_t* metro [[gnu::unused]]) {
}
...
static void delete_accents(metro_t* metro [[gnu::unused]]) {
}

/* option system callback for setting accents option */
int set_accents(metro_t* metro,
                const char* option_name [[gnu::unused]], const char* accents)
{
  if (metro) {
    int i = 0;
